...
// listTags_ returns a function that lists worklink service tags and set them in Context.
...
// updateTags_ returns a function that updates worklink service tags.
// It is called by the transparent tagging interceptor.
