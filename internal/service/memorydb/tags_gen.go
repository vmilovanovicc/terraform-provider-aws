...
// listTags_ returns a function that lists memorydb service tags and set them in Context.
...
// updateTags_ returns a function that updates memorydb service tags.
// It is called by the transparent tagging interceptor.
