...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*mediastore_sdkv1.MediaStore, error) {
	sess := config["session"].(*session_sdkv1.Session)

	return mediastore_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
