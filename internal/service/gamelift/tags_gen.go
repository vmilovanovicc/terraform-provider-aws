...
// listTags_ returns a function that lists gamelift service tags and set them in Context.
...
// updateTags_ returns a function that updates gamelift service tags.
// It is called by the transparent tagging interceptor.
