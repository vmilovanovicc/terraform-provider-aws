...
// listTags_ returns a function that lists opsworks service tags and set them in Context.
...
// updateTags_ returns a function that updates opsworks service tags.
// It is called by the transparent tagging interceptor.
