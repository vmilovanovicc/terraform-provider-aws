...
// listTags_ returns a function that lists dynamodb service tags and set them in Context.
...
// updateTags_ returns a function that updates dynamodb service tags.
// It is called by the transparent tagging interceptor.
